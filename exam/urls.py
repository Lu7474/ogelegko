...
urlpatterns = [
    ...
    path(
        ...
        admin_views.variant_print_docx,
    ...
    path(
        ...
        admin_views.variant_import_status,
    ...
    path(
        ...
        admin_views.catalog_import_status,
    ...
    path(
        ...
        admin_views.catalog_fipi_status,
    ...
    path(
        ...
        admin_views.catalog_import_session_delete,
    ...
    path(
        "admin/catalog/<int:task_id>/assign/", admin_views.catalog_assign_number, name="admin_catalog_assign"
    ),
    ...
    path(
        "admin/variants/auto-generate/", admin_views.variant_auto_generate, name="admin_variant_auto_generate"
    ),
